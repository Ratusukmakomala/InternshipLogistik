...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("
            ...
            sender.name AS sender_name, sender.phone AS sender_phone, sender.address AS sender_address, sender.zip_code AS sender_zip_code,
            receive.name AS receive_name, receive.phone AS receive_phone, receive.address AS receive_address, receive.zip_code AS receive_zip_code,
            sla.name, sla.target,  t.sla_id, t.sla_actual, t.sla_status
            FROM transactions t
